...
def payment_pix_page(payment_id):
   ...
   if payment.paid:  # type: ignore
      return render_template("confirmed_payment.html", payment_id=payment.id, value=payment.value) # type: ignore
    
   return render_template('payment.html', payment_id=payment.id, value=payment.value, host="http://127.0.0.1:5000", qr_code=payment.qr_code) # type: ignore
