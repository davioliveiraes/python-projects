...
class Calculator3:
   ...
   Caso a variância de todos esses numeros for menos que a multiplicação deles, é apresentado uma informação de sucesso ao usuario

   Caso contrário, é apresentando uma informação de falha
   ...
   def calculate(self, request: FlaskRequest) -> Dict: # type: ignore
      ...
      formatted_response = self.__format_exponse(variance)
   ...
   def __format_exponse(self, variance: float) -> Dict:
      return {
         "data": {
            "Calculator": 3,
            "value": variance,
