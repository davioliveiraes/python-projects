...
class Calculator1:
   '''
   * A primeira parte é dividida por 4 e seu resultado somando a 7.
   Após isso, o resultado é elevado ao 
   quadrado e multiplicando por um valor de 0.257.

   * A segunda parte é elevada a potência de 2.121, dividida por 5 e somando a 1
